                    ...
                    <div className="min-h-screen md:pb-32 lg:pb-36 lg:pt-72">
                        ...
                        <div className="absolute inset-0 overflow-hidden">
                            <video
                                ...
                                src="https://www.snamitravel.com/wp-content/uploads/2025/03/selections-snami-only.mp4">
                    ...
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:border-border md:pr-6 mb-4 md:mb-0">
                                <p className="text-center md:text-end text-sm font-medium flex items-center gap-2 justify-center md:justify-end text-foreground">
                            ...
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                <InfiniteSlider
                                    ...
                                    {locations.map((location, index) => (
                                        <div key={index} className="flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-background to-surface border border-border shadow-sm">
                                            <span className="text-2xl">{location.icon}</span>
                                            <span className="font-semibold text-foreground whitespace-nowrap">{location.name}</span>
                                        </div>
                                    ))}
                                </InfiniteSlider>
                            ...
                            <ul className="flex gap-8 text-sm items-center">
                                ...
                                <li className="relative" ref={dropdownRef}>
                                    <button
                                        ...
                                        className="text-primary-foreground hover:text-secondary flex items-center gap-1 duration-150"
                                    >
                                ...
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className="text-primary-foreground hover:text-secondary block duration-150">
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
                            ...
                            <div className="lg:hidden w-full">
                                <ul className="space-y-6 text-base">
                                    ...
                                    <li>
                                        <button
                                            onClick={() => setHotelsDropdownOpen(!hotelsDropdownOpen)}
                                        className="text-primary-foreground hover:text-secondary flex items-center gap-2 w-full duration-150"
                                        >
                                            <span>Our Hotels</span>
                                            <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${hotelsDropdownOpen ? 'rotate-180' : ''}`} />
                                        </button>
        ...
        <svg
            ...
            <defs>
                <linearGradient
                    ...
                    <stop stopColor="var(--color-ivory-dust)" />
                    <stop
                        offset="1"
                        stopColor="var(--color-lavander-clay)"
                    />
                </linearGradient>
            </defs>
        </svg>
